  ...
  return (
    <main className="relative bg-black-100 flex justify-center items-center flex-col mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
      <div className="max-w-7xl w-full mx-auto">
        ...
        <div
          className={`fixed bottom-0 left-1/2 transform -translate-x-1/2 z-50 transition-all duration-300 hidden md:block ${isFooterVisible ? 'opacity-0 translate-y-20 pointer-events-none' : 'opacity-100 translate-y-0'
            }`}
        >
          <AnimatedDock
            items={dockItems}
